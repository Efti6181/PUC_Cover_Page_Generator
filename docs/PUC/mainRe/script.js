...
function setupEventListeners() {
    ...
    document.getElementById('reportNo').addEventListener('input', function() {
        document.getElementById('reportNoPreview').textContent = this.value;
    });
    ...
    document.getElementById('CourseCode').addEventListener('input', function() {
        document.getElementById('CourseCodePreview').textContent = this.value;
    });
